...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-[#5C1311] text-brand-cream select-none">
      ...
      <div className="border-t border-white/10 py-16 px-4 sm:px-6 md:px-[7vw] lg:px-[12vw]">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-10">
          ...
          <div>
            ...
            <p className="text-brand-cream/70 mt-2 max-w-sm text-sm sm:text-base font-semibold leading-relaxed">
              Full-stack developer building scalable web applications and intuitive interfaces.
            </p>
          </div>

          {/* Quick Nav links */}
          <div className="flex flex-wrap gap-x-8 gap-y-4 text-brand-cream/80 font-sans font-extrabold text-xs tracking-widest">
            {[
          ...
          {/* Socials */}
          <div className="flex gap-4 text-brand-cream text-xl">
            {[
      ...
      {/* 2. LOWER STRIP */}
      <div className="border-t border-white/5 py-6 px-4 sm:px-6 md:px-[7vw] lg:px-[12vw]">
